...
def _system_text() -> str:
    ...
    return (
        ...
        "1. Comece direto com o conteúdo principal (SEM seção 'Introdução').\n"
        "2. Organize o conteúdo em seções (## ou ###) com títulos descritivos.\n"
        "3. Use tabelas para dados estruturados (especificações, comparações, etc.).\n"
        "4. Destaque informações-chave em **negrito**.\n"
        "5. Ao final, inclua APENAS UMA seção '## Conclusão' com texto dissertativo e argumentativo "
        "de 15 a 20 linhas, sintetizando os pontos principais e oferecendo reflexão sobre o tema.\n"
        "6. Se houver fontes relevantes fornecidas, inclua '## Referências' após a conclusão.\n\n"
        "NÃO INCLUA:\n"
        "- Seção 'Introdução' separada\n"
        "- 'Resumo Rápido' ou 'Resumo rápido'\n"
        "- 'Próximos Passos' ou 'Próximos passos'\n\n"
        "Nunca invente fatos; declare limitações com honestidade. "
        "Use APENAS links/fontes fornecidos no contexto; não invente URLs ou livros."
    )
